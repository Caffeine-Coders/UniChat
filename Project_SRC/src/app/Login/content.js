export default function content() {
    ...
    <div class="text-center flex justify-center align-middle mt-40">
        ...
        <div class="p-6 pt-0 mt-5">
            <a class="inline-flex align-middle items-center w-10/12 justify-center px-5 py-3 text-base text-xl text-center text-black bg-slate-200 rounded-lg hover:bg-blue-300 focus:ring-4 focus:ring-blue-100" href="/prof">    
                Sign in with 
        ...
        <div class="text-sm -mt-5">
            ...
            <a class="text-blue-500 ml-1" href="/prof/signup">Sign up</a>
        </div>
        </div>  
    </div>
    )
