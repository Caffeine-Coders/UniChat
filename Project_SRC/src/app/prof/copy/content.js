    ...
    <div class="text-center flex justify-center align-middle mt-40">
        ...
        <div class="p-6">
            ...
            <div class="relative w-full mt-6">
                ...
                <button type="submit" class="absolute top-0 end-0 p-2.5 h-full text-sm font-medium text-white bg-blue-400 rounded-e-lg border hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    <svg class="w-6 h-6 text-white transition duration-75 group-hover:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div class="p-6 pt-0">
            <a class="inline-flex align-middle items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-400 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-100" href="/prof/projectdetails">    
                Continue
