    ...
    return (
        <div class="mt-16">
            ...
            <div class="items-center mx-auto content-center justify-center flex mt-10">
                <button class="border border-2 border-black h-32 w-40 rounded-xl items-center bg-white ">
                ...
                <button class="border border-2 border-black h-32 w-40 rounded-xl ml-8  bg-white">
                    <div class="flex items-center justify-center">
