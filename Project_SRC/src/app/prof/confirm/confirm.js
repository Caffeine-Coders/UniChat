export default function Details() {
    return (
        <div class="container my-12 mx-auto lg:px-60 md:px-12">
            ...
            <a class="inline-flex mt-10 items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-400 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-100" href="/prof/details">  
            ...
            <a class="inline-flex mt-10 items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-400 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-100" href="/prof">  Continue  
