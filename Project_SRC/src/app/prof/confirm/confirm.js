    ...
    return (
        <div class="container my-12 mx-auto lg:px-60 md:px-12">
            ...
            <a class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-black border border-2 border-black rounded-lg bg-white hover:bg-slate-300 focus:ring-4 focus:ring-blue-100" href="/prof/details">    
                ...
                <a class="inline-flex float-right items-center justify-center px-5 py-3 text-base font-medium text-center text-discordgreen-100 bg-white border-2 border-black rounded-lg hover:bg-slate-200 focus:ring-4 focus:ring-blue-100 group" href="/prof/copy">    
                    Create Project 
