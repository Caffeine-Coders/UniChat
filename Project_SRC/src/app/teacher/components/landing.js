export default function Landing() {
    return (
        ...
        <a class="inline-flex mt-10 items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-discordpurple-100 rounded-lg hover:bg-discordpurple-200 focus:ring-4 focus:ring-blue-100" href="/te@cher/login">  Get Started 
