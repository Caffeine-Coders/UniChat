export default function content() {
    ...
    <div class="text-center flex justify-center align-middle mt-40">
        <div class="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-1/4 backdrop-filter backdrop-blur-sm bg-opacity-30">
        <div class="p-6">
        ...
        <div class="p-6 pt-0">
            <a class="inline-flex align-middle items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-discordpurple-100 rounded-lg hover:bg-discordpurple-200 focus:ring-4 focus:ring-blue-100" href="/te@cher/prof/projectdetails">    
                Continue
