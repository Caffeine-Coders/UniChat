    ...
    return (
            <>
                    ...
                    <div class="items-center mx-auto content-center justify-center flex mt-10">
                        <button class="border-2 border-black h-32 w-40 rounded-xl items-center bg-white ">
                        ...
                        <button class="border-2 border-black ml-8 h-32 w-40 rounded-xl items-center bg-white ">
                            <div class="flex items-center justify-center">
