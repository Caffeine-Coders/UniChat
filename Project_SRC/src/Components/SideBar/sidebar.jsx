            ...
            <List sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                >
                        ...
                        <AccordionDetails>
                            ...
                            >
                                <Button sx={{color: (theme) => theme.palette.primary.textcolor, "&:hover": {backgroundColor: (theme) => theme.palette.primary.hover}}} >Project 1</Button>
                                <Divider sx={{backgroundColor: (theme) => theme.palette.primary.textcolor}} />
                                <Button sx={{color: (theme) => theme.palette.primary.textcolor, "&:hover": {backgroundColor: (theme) => theme.palette.primary.hover}}} >Project 2</Button>
                                <Divider sx={{backgroundColor: (theme) => theme.palette.primary.textcolor,  "&:hover": {backgroundColor: (theme) => theme.palette.primary.hover}}} />
                                <Button sx={{color: (theme) => theme.palette.primary.textcolor,  "&:hover": {backgroundColor: (theme) => theme.palette.primary.hover}}} >Project 3</Button>
                                <Divider sx={{backgroundColor: (theme) => theme.palette.primary.textcolor}} />
                                <Button sx={{color: (theme) => theme.palette.primary.textcolor,  "&:hover": {backgroundColor: (theme) => theme.palette.primary.hover}}} >Project 4</Button>
                                <Divider sx={{backgroundColor: (theme) => theme.palette.primary.textcolor}} />
                                <Button sx={{color: (theme) => theme.palette.primary.textcolor,  "&:hover": {backgroundColor: (theme) => theme.palette.primary.hover}}} >Project 5</Button>
                                <Divider sx={{backgroundColor: (theme) => theme.palette.primary.textcolor}} />
                            </Stack>
                        </AccordionDetails>
                    </Accordion>
